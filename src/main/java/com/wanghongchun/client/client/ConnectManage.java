...
public class ConnectManage implements InitializingBean{
    ...
    public void setConnectedHandlers(CopyOnWriteArrayList<RpcClientHandler> connectedHandlers) {
        this.connectedHandlers = connectedHandlers;
    }

    public Map<InetSocketAddress, RpcClientHandler> getConnectedServerNodes() {
        return connectedServerNodes;
    }

    public void setConnectedServerNodes(Map<InetSocketAddress, RpcClientHandler> connectedServerNodes) {
        this.connectedServerNodes = connectedServerNodes;
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        InetSocketAddress remotePeer = new InetSocketAddress("localhost",8089);
